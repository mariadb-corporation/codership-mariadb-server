...
/*
  ...
  are allocated for each thread (see threadpool_add_connection()),
  and stored in thd->mysys_var when the THD object is not active,
  and this must be taken into account when storing/resetting
  thread local storage and when creating streaming applier THDs.
*/
