...
public:
	...
	**/
	static const byte TRX_WSREP_ON = 1;
	static const byte TRX_WSREP_BF = 2;
	static const byte TRX_WSREP_UK_SCAN = 4;
	byte		wsrep;
	...
	void wsrep_end_UK_scan() {wsrep &= ~(trx_t::TRX_WSREP_UK_SCAN); }
#else /* WITH_WSREP */
